...
- [istio/istio](https://github.com/istio/istio) ([1.24.0-rc.0](https://github.com/istio/istio/releases/tag/1.24.0-rc.0), 2 days ago) - Connect, secure, control, and observe services.
- [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) ([v1.32.0-alpha.3](https://github.com/kubernetes/kubernetes/releases/tag/v1.32.0-alpha.3), 4 days ago) - Production-Grade Container Scheduling and Management
