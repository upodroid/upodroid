...
- [kubernetes/registry.k8s.io](https://github.com/kubernetes/registry.k8s.io) ([v0.7.0](https://github.com/kubernetes/registry.k8s.io/releases/tag/v0.7.0), 5 days ago) - This project is the repo for registry.k8s.io, the production OCI registry service for Kubernetes&#39; container image artifacts
