...
- [kyverno/kyverno](https://github.com/kyverno/kyverno) ([v1.17.0-rc.1](https://github.com/kyverno/kyverno/releases/tag/v1.17.0-rc.1), 4 days ago) - Cloud Native Policy Management
...
- [add region, machine-type and worker-pool flags to image builder](https://github.com/kubernetes/test-infra/pull/36296) on [kubernetes/test-infra](https://github.com/kubernetes/test-infra) (2 days ago)
- [refactor image-util script that builds e2e test-images](https://github.com/kubernetes/kubernetes/pull/136464) on [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) (2 days ago)
- [drop armv7 from our e2e test images](https://github.com/kubernetes/kubernetes/pull/136444) on [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) (2 days ago)
