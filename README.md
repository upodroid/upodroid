...
- [kubernetes/kops](https://github.com/kubernetes/kops) ([v1.36.2](https://github.com/kubernetes/kops/releases/tag/v1.36.2), 3 days ago) - Kubernetes Operations (kOps) - Production Grade k8s Installation, Upgrades and Management
...
- [fix sending v prefixed semver version to older etcd peer versions that use the coreos/go-semver](https://github.com/etcd-io/etcd/pull/22261) on [etcd-io/etcd](https://github.com/etcd-io/etcd) (2 days ago)
