...
- [kubernetes/kops](https://github.com/kubernetes/kops) ([v1.30.1](https://github.com/kubernetes/kops/releases/tag/v1.30.1), 2 days ago) - Kubernetes Operations (kOps) - Production Grade k8s Installation, Upgrades and Management
- [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) ([v1.30.5](https://github.com/kubernetes/kubernetes/releases/tag/v1.30.5), 3 days ago) - Production-Grade Container Scheduling and Management
...
- [kubernetes/release](https://github.com/kubernetes/release) ([v0.17.7](https://github.com/kubernetes/release/releases/tag/v0.17.7), 4 days ago) - Release infrastructure for Kubernetes and related components
