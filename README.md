...
- [containerd/containerd](https://github.com/containerd/containerd) ([v1.6.32](https://github.com/containerd/containerd/releases/tag/v1.6.32), 2 days ago) - An open and reliable container runtime
- [kubernetes-sigs/release-sdk](https://github.com/kubernetes-sigs/release-sdk) ([v0.11.1](https://github.com/kubernetes-sigs/release-sdk/releases/tag/v0.11.1), 2 days ago) - Interfaces and implementations for building Kubernetes releases.
- [knative-extensions/eventing-kafka-broker](https://github.com/knative-extensions/eventing-kafka-broker) ([knative-v1.14.3](https://github.com/knative-extensions/eventing-kafka-broker/releases/tag/knative-v1.14.3), 3 days ago) - Alternate Kafka Broker implementation.
