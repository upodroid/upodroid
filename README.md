...
- [kubernetes/kops](https://github.com/kubernetes/kops) ([v1.36.2](https://github.com/kubernetes/kops/releases/tag/v1.36.2), 1 day ago) - Kubernetes Operations (kOps) - Production Grade k8s Installation, Upgrades and Management
...
- [bump argocd to v3.4.6 and enable ssa for diffs](https://github.com/kubernetes/k8s.io/pull/9804) on [kubernetes/k8s.io](https://github.com/kubernetes/k8s.io) (6 days ago)
- [bump memory for registry.k8s.io presubmits](https://github.com/kubernetes/test-infra/pull/37608) on [kubernetes/test-infra](https://github.com/kubernetes/test-infra) (6 days ago)
