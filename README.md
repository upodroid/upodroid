...
- [istio/istio](https://github.com/istio/istio) ([1.27.0-rc.0](https://github.com/istio/istio/releases/tag/1.27.0-rc.0), 6 days ago) - Connect, secure, control, and observe services.
- [kyverno/kyverno](https://github.com/kyverno/kyverno) ([v1.15.0](https://github.com/kyverno/kyverno/releases/tag/v1.15.0), 1 week ago) - Cloud Native Policy Management
...
- [dump node info in the podinfo.json file](https://github.com/kubernetes-sigs/prow/pull/503) on [kubernetes-sigs/prow](https://github.com/kubernetes-sigs/prow) (1 week ago)
- [connect the s390x cluster to argocd](https://github.com/kubernetes/k8s.io/pull/8332) on [kubernetes/k8s.io](https://github.com/kubernetes/k8s.io) (2 weeks ago)
...
- [use a base image that supports s390x/ppc64le](https://github.com/kyverno/kyverno/pull/13349) on [kyverno/kyverno](https://github.com/kyverno/kyverno) (2 months ago)
- [bump atlantis and reconcile manual changes](https://github.com/kubernetes/k8s.io/pull/8176) on [kubernetes/k8s.io](https://github.com/kubernetes/k8s.io) (2 months ago)
- [add extra kubernetes manifests](https://github.com/DataDog/helm-charts/pull/1904) on [DataDog/helm-charts](https://github.com/DataDog/helm-charts) (2 months ago)
