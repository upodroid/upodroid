...
- [istio/istio](https://github.com/istio/istio) ([1.21.6](https://github.com/istio/istio/releases/tag/1.21.6), 6 days ago) - Connect, secure, control, and observe services.
...
- [switch to the new prow image registry](https://github.com/knative/infra/pull/518) on [knative/infra](https://github.com/knative/infra) (3 days ago)
- [Deploy Istio to the utility cluster](https://github.com/kubernetes/k8s.io/pull/7341) on [kubernetes/k8s.io](https://github.com/kubernetes/k8s.io) (4 days ago)
- [enable dualstack on services created by Gateway API](https://github.com/istio/istio/pull/53245) on [istio/istio](https://github.com/istio/istio) (6 days ago)
