...
- [istio/istio](https://github.com/istio/istio) ([1.27.0-rc.0](https://github.com/istio/istio/releases/tag/1.27.0-rc.0), today) - Connect, secure, control, and observe services.
- [kyverno/kyverno](https://github.com/kyverno/kyverno) ([v1.15.0](https://github.com/kyverno/kyverno/releases/tag/v1.15.0), 4 days ago) - Cloud Native Policy Management
...
- [dump node info in the podinfo.json file](https://github.com/kubernetes-sigs/prow/pull/503) on [kubernetes-sigs/prow](https://github.com/kubernetes-sigs/prow) (1 day ago)
