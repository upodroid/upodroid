...
- [knative-extensions/eventing-kafka-broker](https://github.com/knative-extensions/eventing-kafka-broker) ([knative-v1.14.8](https://github.com/knative-extensions/eventing-kafka-broker/releases/tag/knative-v1.14.8), 4 days ago) - Alternate Kafka Broker implementation.
...
- [Use a dedicated kubernetes service account for azure jobs](https://github.com/kubernetes/k8s.io/pull/7117) on [kubernetes/k8s.io](https://github.com/kubernetes/k8s.io) (2 days ago)
- [Remove geo replication for GCR](https://github.com/knative/hack/pull/389) on [knative/hack](https://github.com/knative/hack) (2 days ago)
- [reduce job frequencies for release branches and serving e2e&#39;s](https://github.com/knative/infra/pull/494) on [knative/infra](https://github.com/knative/infra) (2 days ago)
