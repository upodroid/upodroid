...
- [knative-extensions/eventing-kafka-broker](https://github.com/knative-extensions/eventing-kafka-broker) ([knative-v1.13.11](https://github.com/knative-extensions/eventing-kafka-broker/releases/tag/knative-v1.13.11), 6 days ago) - Alternate Kafka Broker implementation.
...
- [kubernetes-sigs/gcp-compute-persistent-disk-csi-driver](https://github.com/kubernetes-sigs/gcp-compute-persistent-disk-csi-driver) ([v1.10.18](https://github.com/kubernetes-sigs/gcp-compute-persistent-disk-csi-driver/releases/tag/v1.10.18), 2 weeks ago) - The Google Compute Engine Persistent Disk (GCE PD) Container Storage Interface (CSI) Storage Plugin.
...
- [Migrate capi/kops digitalocean creds to community cluster](https://github.com/kubernetes/k8s.io/pull/6967) on [kubernetes/k8s.io](https://github.com/kubernetes/k8s.io) (5 days ago)
