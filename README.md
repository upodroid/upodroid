...
- [kubernetes/kops](https://github.com/kubernetes/kops) ([v1.36.0-beta.1](https://github.com/kubernetes/kops/releases/tag/v1.36.0-beta.1), 4 days ago) - Kubernetes Operations (kOps) - Production Grade k8s Installation, Upgrades and Management
...
- [kubernetes-sigs/gateway-api](https://github.com/kubernetes-sigs/gateway-api) ([v1.6.0-rc.1](https://github.com/kubernetes-sigs/gateway-api/releases/tag/v1.6.0-rc.1), 6 days ago) - Repository for the next iteration of composite service (e.g. Ingress) and load balancing APIs.
...
- [manage elekto with argocd, migrate the secrets to ESO and squash some bugs](https://github.com/kubernetes/k8s.io/pull/9601) on [kubernetes/k8s.io](https://github.com/kubernetes/k8s.io) (4 days ago)
