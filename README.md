...
- [kubernetes/release](https://github.com/kubernetes/release) ([v0.17.7](https://github.com/kubernetes/release/releases/tag/v0.17.7), today) - Release infrastructure for Kubernetes and related components
- [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) ([v1.28.14](https://github.com/kubernetes/kubernetes/releases/tag/v1.28.14), today) - Production-Grade Container Scheduling and Management
