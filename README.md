...
- [kyverno/kyverno](https://github.com/kyverno/kyverno) ([v1.16.1-rc.2](https://github.com/kyverno/kyverno/releases/tag/v1.16.1-rc.2), today) - Cloud Native Policy Management
- [kubernetes/kops](https://github.com/kubernetes/kops) ([v1.35.0-alpha.1](https://github.com/kubernetes/kops/releases/tag/v1.35.0-alpha.1), 1 day ago) - Kubernetes Operations (kOps) - Production Grade k8s Installation, Upgrades and Management
...
- [talkiq/gcloud-aio](https://github.com/talkiq/gcloud-aio) ([storage-9.6.1](https://github.com/talkiq/gcloud-aio/releases/tag/storage-9.6.1), 3 weeks ago) - (Asyncio OR Threadsafe) Google Cloud Client Library for Python
...
- [iptables is deprecated and broken on rhel10&#43; so use nftables by default](https://github.com/kubernetes/kops/pull/17789) on [kubernetes/kops](https://github.com/kubernetes/kops) (today)
- [recognise rhel 10 and its variants &#43; fedora &#43; centos stream](https://github.com/kubernetes/kops/pull/17785) on [kubernetes/kops](https://github.com/kubernetes/kops) (1 day ago)
- [drop stale conformance mailing lists](https://github.com/kubernetes/k8s.io/pull/8822) on [kubernetes/k8s.io](https://github.com/kubernetes/k8s.io) (1 day ago)
- [[WIP] expand to all S3 regions for registry.k8s.io](https://github.com/kubernetes/k8s.io/pull/8819) on [kubernetes/k8s.io](https://github.com/kubernetes/k8s.io) (2 days ago)
- [[WIP] create the remaining AR registries and start using terraform to manage the k8s-artifacts-prod project](https://github.com/kubernetes/k8s.io/pull/8817) on [kubernetes/k8s.io](https://github.com/kubernetes/k8s.io) (2 days ago)
- [update the ips for Q4 2025 and expand to all AWS regions](https://github.com/kubernetes/registry.k8s.io/pull/315) on [kubernetes/registry.k8s.io](https://github.com/kubernetes/registry.k8s.io) (2 days ago)
