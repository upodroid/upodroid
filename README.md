...
- [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) ([v1.32.0-alpha.1](https://github.com/kubernetes/kubernetes/releases/tag/v1.32.0-alpha.1), 2 days ago) - Production-Grade Container Scheduling and Management
...
- [Configure AWS SSO for aws-capa-ami account](https://github.com/kubernetes/k8s.io/pull/7366) on [kubernetes/k8s.io](https://github.com/kubernetes/k8s.io) (4 days ago)
- [switch to the new prow image registry](https://github.com/knative/infra/pull/518) on [knative/infra](https://github.com/knative/infra) (1 week ago)
