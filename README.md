...
- [kubernetes/release](https://github.com/kubernetes/release) ([v0.19.0](https://github.com/kubernetes/release/releases/tag/v0.19.0), 4 days ago) - Release infrastructure for Kubernetes and related components
...
- [enable metrics server for scale tests](https://github.com/kubernetes/kops/pull/17938) on [kubernetes/kops](https://github.com/kubernetes/kops) (2 days ago)
- [add exponential backoffs to calling kops-controller](https://github.com/kubernetes/kops/pull/17930) on [kubernetes/kops](https://github.com/kubernetes/kops) (3 days ago)
- [make some etcd variables configurable](https://github.com/kubernetes/kops/pull/17929) on [kubernetes/kops](https://github.com/kubernetes/kops) (4 days ago)
