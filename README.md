...
- [kubernetes/kops](https://github.com/kubernetes/kops) ([v1.35.0-beta.1](https://github.com/kubernetes/kops/releases/tag/v1.35.0-beta.1), 2 days ago) - Kubernetes Operations (kOps) - Production Grade k8s Installation, Upgrades and Management
...
- [kyverno/kyverno](https://github.com/kyverno/kyverno) ([v1.17.0](https://github.com/kyverno/kyverno/releases/tag/v1.17.0), 2 weeks ago) - Cloud Native Policy Management
...
- [publish a proper website with kubernetes download instructions ](https://github.com/kubernetes-sigs/downloadkubernetes/pull/845) on [kubernetes-sigs/downloadkubernetes](https://github.com/kubernetes-sigs/downloadkubernetes) (1 day ago)
- [drop managing storage classes](https://github.com/kubernetes/perf-tests/pull/3806) on [kubernetes/perf-tests](https://github.com/kubernetes/perf-tests) (2 days ago)
- [fetch metrics correctly from control plane instances](https://github.com/kubernetes/perf-tests/pull/3805) on [kubernetes/perf-tests](https://github.com/kubernetes/perf-tests) (3 days ago)
- [bump cni plugins for node e2e jobs and fetch from github](https://github.com/kubernetes/test-infra/pull/36448) on [kubernetes/test-infra](https://github.com/kubernetes/test-infra) (4 days ago)
- [serve k8s-release-dev and k8s-staging-kops via Fastly](https://github.com/kubernetes/k8s.io/pull/9112) on [kubernetes/k8s.io](https://github.com/kubernetes/k8s.io) (4 days ago)
- [fix dl.k8s.io cdn](https://github.com/kubernetes/k8s.io/pull/9109) on [kubernetes/k8s.io](https://github.com/kubernetes/k8s.io) (5 days ago)
- [add dl.k8s.dev for testing Fastly CDN and also serving staging release bucket](https://github.com/kubernetes/k8s.io/pull/9100) on [kubernetes/k8s.io](https://github.com/kubernetes/k8s.io) (6 days ago)
...
- [add helm cli to e2e image](https://github.com/kubernetes/test-infra/pull/36421) on [kubernetes/test-infra](https://github.com/kubernetes/test-infra) (1 week ago)
- [add pre-test-cmd](https://github.com/kubernetes-sigs/kubetest2/pull/325) on [kubernetes-sigs/kubetest2](https://github.com/kubernetes-sigs/kubetest2) (1 week ago)
