...
- [containerd/containerd](https://github.com/containerd/containerd) ([v1.7.16](https://github.com/containerd/containerd/releases/tag/v1.7.16), 6 days ago) - An open and reliable container runtime
...
- [Add support for specifying extra manifests via helm](https://github.com/external-secrets/external-secrets/pull/3421) on [external-secrets/external-secrets](https://github.com/external-secrets/external-secrets) (3 days ago)
