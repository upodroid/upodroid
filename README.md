...
- [external-secrets/external-secrets](https://github.com/external-secrets/external-secrets) ([v0.14.3](https://github.com/external-secrets/external-secrets/releases/tag/v0.14.3), today) - External Secrets Operator reads information from a third-party service like AWS Secrets Manager and automatically injects the values as Kubernetes Secrets.
- [istio/istio](https://github.com/istio/istio) ([1.25.0-rc.1](https://github.com/istio/istio/releases/tag/1.25.0-rc.1), 2 days ago) - Connect, secure, control, and observe services.
...
- [create jobset and lws image registries](https://github.com/kubernetes/k8s.io/pull/7824) on [kubernetes/k8s.io](https://github.com/kubernetes/k8s.io) (2 days ago)
