...
- [istio/istio](https://github.com/istio/istio) ([1.25.0-rc.0](https://github.com/istio/istio/releases/tag/1.25.0-rc.0), 3 days ago) - Connect, secure, control, and observe services.
...
- [create jobset and lws image registries](https://github.com/kubernetes/k8s.io/pull/7824) on [kubernetes/k8s.io](https://github.com/kubernetes/k8s.io) (today)
