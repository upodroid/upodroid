...
- [kubernetes/kops](https://github.com/kubernetes/kops) ([v1.28.7](https://github.com/kubernetes/kops/releases/tag/v1.28.7), 1 day ago) - Kubernetes Operations (kOps) - Production Grade k8s Installation, Upgrades and Management
...
- [kubernetes-sigs/gcp-compute-persistent-disk-csi-driver](https://github.com/kubernetes-sigs/gcp-compute-persistent-disk-csi-driver) ([v999.2.4](https://github.com/kubernetes-sigs/gcp-compute-persistent-disk-csi-driver/releases/tag/v999.2.4), 4 days ago) - The Google Compute Engine Persistent Disk (GCE PD) Container Storage Interface (CSI) Storage Plugin.
- [containerd/containerd](https://github.com/containerd/containerd) ([v1.7.20](https://github.com/containerd/containerd/releases/tag/v1.7.20), 4 days ago) - An open and reliable container runtime
- [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) ([v1.27.16](https://github.com/kubernetes/kubernetes/releases/tag/v1.27.16), 5 days ago) - Production-Grade Container Scheduling and Management
- [knative/eventing](https://github.com/knative/eventing) ([knative-v1.14.5](https://github.com/knative/eventing/releases/tag/knative-v1.14.5), 6 days ago) - Event-driven application platform for Kubernetes
...
- [kubernetes/release](https://github.com/kubernetes/release) ([v0.17.1](https://github.com/kubernetes/release/releases/tag/v0.17.1), 3 weeks ago) - Release infrastructure for Kubernetes and related components
...
- [run cloudbuild job for kueue in k8s-staging-images](https://github.com/kubernetes/test-infra/pull/33034) on [kubernetes/test-infra](https://github.com/kubernetes/test-infra) (3 days ago)
- [configure kueue to promote from AR instead of GCR](https://github.com/kubernetes/k8s.io/pull/7033) on [kubernetes/k8s.io](https://github.com/kubernetes/k8s.io) (3 days ago)
- [migrate capi digitalocean jobs to community cluster](https://github.com/kubernetes/test-infra/pull/32992) on [kubernetes/test-infra](https://github.com/kubernetes/test-infra) (6 days ago)
