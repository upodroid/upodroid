...
- [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) ([v1.32.0-rc.1](https://github.com/kubernetes/kubernetes/releases/tag/v1.32.0-rc.1), today) - Production-Grade Container Scheduling and Management
- [kubernetes/kops](https://github.com/kubernetes/kops) ([v1.30.3](https://github.com/kubernetes/kops/releases/tag/v1.30.3), today) - Kubernetes Operations (kOps) - Production Grade k8s Installation, Upgrades and Management
