...
- [kubernetes/release](https://github.com/kubernetes/release) ([v0.19.0](https://github.com/kubernetes/release/releases/tag/v0.19.0), 3 days ago) - Release infrastructure for Kubernetes and related components
...
- [[wip] access boskos accounts via IAM roles](https://github.com/kubernetes/k8s.io/pull/9087) on [kubernetes/k8s.io](https://github.com/kubernetes/k8s.io) (today)
...
- [make some etcd variables configurable](https://github.com/kubernetes/kops/pull/17929) on [kubernetes/kops](https://github.com/kubernetes/kops) (3 days ago)
- [configure scraping etcd ports on kops](https://github.com/kubernetes/perf-tests/pull/3797) on [kubernetes/perf-tests](https://github.com/kubernetes/perf-tests) (3 days ago)
- [build k/k when running presubmit jobs in kubernetes repo](https://github.com/kubernetes/kops/pull/17927) on [kubernetes/kops](https://github.com/kubernetes/kops) (4 days ago)
