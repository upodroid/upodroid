...
- [istio/istio](https://github.com/istio/istio) ([1.22.6](https://github.com/istio/istio/releases/tag/1.22.6), 3 days ago) - Connect, secure, control, and observe services.
- [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) ([v1.31.2](https://github.com/kubernetes/kubernetes/releases/tag/v1.31.2), 3 days ago) - Production-Grade Container Scheduling and Management
- [kubernetes/release](https://github.com/kubernetes/release) ([v0.17.10](https://github.com/kubernetes/release/releases/tag/v0.17.10), 3 days ago) - Release infrastructure for Kubernetes and related components
