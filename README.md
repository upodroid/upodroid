...
- [kubernetes/kops](https://github.com/kubernetes/kops) ([v1.36.0-beta.1](https://github.com/kubernetes/kops/releases/tag/v1.36.0-beta.1), 6 days ago) - Kubernetes Operations (kOps) - Production Grade k8s Installation, Upgrades and Management
...
- [fix caddy validate when using envfile](https://github.com/sebdanielsson/ansible-role-xcaddy/pull/39) on [sebdanielsson/ansible-role-xcaddy](https://github.com/sebdanielsson/ansible-role-xcaddy) (1 day ago)
- [manage elekto with argocd, migrate the secrets to ESO and squash some bugs](https://github.com/kubernetes/k8s.io/pull/9601) on [kubernetes/k8s.io](https://github.com/kubernetes/k8s.io) (6 days ago)
