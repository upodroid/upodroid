...
- [kubernetes-sigs/gcp-compute-persistent-disk-csi-driver](https://github.com/kubernetes-sigs/gcp-compute-persistent-disk-csi-driver) ([v1.25.2](https://github.com/kubernetes-sigs/gcp-compute-persistent-disk-csi-driver/releases/tag/v1.25.2), 1 day ago) - The Google Compute Engine Persistent Disk (GCE PD) Container Storage Interface (CSI) Storage Plugin.
...
- [kubernetes/release](https://github.com/kubernetes/release) ([v0.21.1](https://github.com/kubernetes/release/releases/tag/v0.21.1), 3 weeks ago) - Release infrastructure for Kubernetes and related components
- [kubernetes-sigs/gateway-api](https://github.com/kubernetes-sigs/gateway-api) ([monthly-2026.04](https://github.com/kubernetes-sigs/gateway-api/releases/tag/monthly-2026.04), 4 weeks ago) - Repository for the next iteration of composite service (e.g. Ingress) and load balancing APIs.
...
- [fix a bug with e2e image test pipeline](https://github.com/kubernetes/kubernetes/pull/138748) on [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) (3 days ago)
...
- [fix verify-index errors](https://github.com/kubernetes-sigs/downloadkubernetes/pull/894) on [kubernetes-sigs/downloadkubernetes](https://github.com/kubernetes-sigs/downloadkubernetes) (1 week ago)
- [Initial support for Ubuntu 26.04](https://github.com/kubernetes/kops/pull/18232) on [kubernetes/kops](https://github.com/kubernetes/kops) (1 week ago)
- [add dns staging registry](https://github.com/kubernetes/k8s.io/pull/9373) on [kubernetes/k8s.io](https://github.com/kubernetes/k8s.io) (2 weeks ago)
- [promote cloud-provider-gcp binaries for v35.1.0](https://github.com/kubernetes/k8s.io/pull/9371) on [kubernetes/k8s.io](https://github.com/kubernetes/k8s.io) (2 weeks ago)
- [fix sig-scheduling testgrid board](https://github.com/kubernetes/test-infra/pull/36858) on [kubernetes/test-infra](https://github.com/kubernetes/test-infra) (2 weeks ago)
