...
- [kubernetes/kops](https://github.com/kubernetes/kops) ([v1.36.0-alpha.1](https://github.com/kubernetes/kops/releases/tag/v1.36.0-alpha.1), today) - Kubernetes Operations (kOps) - Production Grade k8s Installation, Upgrades and Management
...
- [add gh cli to kubekins-e2e image](https://github.com/kubernetes/test-infra/pull/37085) on [kubernetes/test-infra](https://github.com/kubernetes/test-infra) (3 days ago)
- [strip the url prefix when accessing kops ci bucket](https://github.com/kubernetes/k8s.io/pull/9520) on [kubernetes/k8s.io](https://github.com/kubernetes/k8s.io) (5 days ago)
