...
- [knative/eventing](https://github.com/knative/eventing) ([knative-v1.14.1](https://github.com/knative/eventing/releases/tag/knative-v1.14.1), 3 days ago) - Event-driven application platform for Kubernetes
- [knative-extensions/eventing-kafka-broker](https://github.com/knative-extensions/eventing-kafka-broker) ([knative-v1.13.9](https://github.com/knative-extensions/eventing-kafka-broker/releases/tag/knative-v1.13.9), 3 days ago) - Alternate Kafka Broker implementation.
- [containerd/containerd](https://github.com/containerd/containerd) ([api/v1.8.0-rc.0](https://github.com/containerd/containerd/releases/tag/api/v1.8.0-rc.0), 4 days ago) - An open and reliable container runtime
